...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      fundPool: (...args_1) => {
        ...
        const totalAmount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('fundPool',
                                     'argument 1 (as invoked from Typescript)',
                                     'bboard.compact line 66 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(totalAmount_0),
        ...
        const result_0 = this._fundPool_0(context,
                                          partialProofData,
                                          totalAmount_0);
      ...
      commitSplit: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`commitSplit: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const recipientKey_0 = args_1[1];
        const commitment_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('commitSplit',
                                     'argument 1 (as invoked from Typescript)',
                                     'bboard.compact line 75 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(recipientKey_0).concat(_descriptor_0.toValue(commitment_0)),
        ...
        const result_0 = this._commitSplit_0(context,
                                             partialProofData,
                                             recipientKey_0,
                                             commitment_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      claimPayout: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const recipientKey_0 = args_1[1];
        const periodId_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claimPayout',
                                     'argument 1 (as invoked from Typescript)',
                                     'bboard.compact line 97 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(recipientKey_0.buffer instanceof ArrayBuffer && recipientKey_0.BYTES_PER_ELEMENT === 1 && recipientKey_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(recipientKey_0).concat(_descriptor_0.toValue(periodId_0)),
            alignment: _descriptor_0.alignment().concat(_descriptor_0.alignment())
          },
          output: undefined,
          publicTranscript: [],
      ...
      proveIncomeAtLeast: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`proveIncomeAtLeast: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const recipientKey_0 = args_1[1];
        const threshold_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveIncomeAtLeast',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(recipientKey_0).concat(_descriptor_2.toValue(threshold_0)),
        ...
        const result_0 = this._proveIncomeAtLeast_0(context,
                                                    partialProofData,
                                                    recipientKey_0,
                                                    threshold_0);
      ...
      isClaimed: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`isClaimed: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const nullifier_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isClaimed',
                                     'argument 1 (as invoked from Typescript)',
                                     'bboard.compact line 146 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._isClaimed_0(context,
                                           partialProofData,
                                           nullifier_0);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      commitSplit: this.circuits.commitSplit,
      claimPayout: this.circuits.claimPayout,
      proveIncomeAtLeast: this.circuits.proveIncomeAtLeast,
      isClaimed: this.circuits.isClaimed
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('commitSplit', new __compactRuntime.ContractOperation());
    state_0.setOperation('claimPayout', new __compactRuntime.ContractOperation());
    state_0.setOperation('proveIncomeAtLeast', new __compactRuntime.ContractOperation());
    state_0.setOperation('isClaimed', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(0n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(totalAmount_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _commitSplit_0(context, partialProofData, recipientKey_0, commitment_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(recipientKey_0),
  ...
  _claimPayout_0(context, partialProofData, recipientKey_0, periodId_0) {
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            &&
                            this._equal_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
                                                                                                     ...
                                                                                                     { idx: { cached: false,
                                                                                                              ...
                                                                                                              path: [
                                                                                                                     { tag: 'value',
                                                                                                                       value: { value: _descriptor_0.toValue(recipientKey_0),
                                                                                                                                alignment: _descriptor_0.alignment() } }] } },
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          leaf_0),
  ...
  _proveIncomeAtLeast_0(context, partialProofData, recipientKey_0, threshold_0)
  {
    const amt_0 = this._amount_0(context, partialProofData);
    const s_0 = this._salt_0(context, partialProofData);
    const leaf_0 = this._persistentHash_0([this._persistentHash_1(amt_0), s_0]);
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            this._equal_1(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                          ...
                                          leaf_0),
                            'amount/salt do not match the published commitment');
    return amt_0 >= threshold_0;
  }
  _isClaimed_0(context, partialProofData, nullifier_0) {
